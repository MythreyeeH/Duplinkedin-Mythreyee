...
* **Users:** Master table for profiles and authentication.
* **Connections:** Managed via ordered User IDs to prevent duplicate relationship entries.
* **Hashtags:** Many-to-one mapping for optimized content discovery.
* **Messages/Comments:** Relational tables with foreign key constraints to maintain data integrity.
